...
$no_of_books="SELECT `No_of_book_avl` from `test`.`stud_det` where `RollNo`='".$rollno."' ";
...
mysqli_query($conn,$update1);
 ...
 echo"<br>";echo"<br>";
  echo"<font color=black><b>Book Returned by the student Successfully</b></font>";
?>
<br>
<br>
<br>
<b>
<a href="return.php">click here</a> to Return another book
</b>
</div>
</body>
</html> 
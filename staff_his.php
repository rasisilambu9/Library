...
<body>
 <div class="topnav">
  ...
  <a href="return_staff.php">ReturnBy Staff</a>
...
<form method=POST action=staff_hist.php class="form1">
<font color=black><b>Staff ID	</b></font><br>
<input type=longtext name="rollno"   placeholder="Register No" required></input><br>	
...
<input type=date name="end_date" required></input><br><br>

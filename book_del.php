...
$query="Select * from`test`.`book_det` where `Book_id`='".$bookid."'";
$result=mysqli_query($conn,$query);
$query1= "Delete from `test`.`book_det` where `Book_id`='".$bookid."'";
...
echo"<font color=black><b>Book deleted successfully</b></font>"; }
